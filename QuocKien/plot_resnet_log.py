...
plt.title('ResNet18 Detector Training Loss', fontsize=14)
plt.xlabel('Epoch', fontsize=12)
plt.ylabel('Loss', fontsize=12)
plt.grid(True, linestyle='--', alpha=0.7)
loss_out_path = out_dir / "resnet18_loss_plot.png"
plt.tight_layout()
...
plt.title('ResNet18 Detector Validation mAP50', fontsize=14)
plt.xlabel('Epoch', fontsize=12)
plt.ylabel('mAP50', fontsize=12)
plt.grid(True, linestyle='--', alpha=0.7)
map_out_path = out_dir / "resnet18_map50_plot.png"
plt.tight_layout()
